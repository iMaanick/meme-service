...
@pytest.mark.asyncio
async def test_get_file_url_success(private_client: TestClient, mock_storage_gateway: AsyncMock):
...
@pytest.mark.asyncio
async def test_get_file_url_not_found(private_client: TestClient, mock_storage_gateway: AsyncMock):
