...
@pytest.mark.asyncio
async def test_get_memes(client: TestClient, mock_database_gateway: AsyncMock) -> None:
...
@pytest.mark.asyncio
async def test_get_memes_empty_list(client: TestClient, mock_database_gateway: AsyncMock) -> None:
    mock_database_gateway.get_memes.return_value = []
